...
public class NewTaskActivity extends Activity {
    ...
    public static final String AUTO_TASK_TAG = "AutoTask";
    ...
    private void saveTask() {
        ...
        try {
            ...
            appendContig(builder, "trigger.classes", triggersList);
            appendContig(builder, "actions.classes", actionsList);
    ...
    private void appendContig(StringBuilder builder, String classesPropName, List<TaskObject> taskObjectList) {
